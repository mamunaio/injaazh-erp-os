...
const oldCallGemini = /const response = await ai\.models\.generateContent\(\{\s*model: 'gemini-2\.5-flash',\s*contents: fullPrompt,\s*config: options\.jsonMode \? \{ responseMimeType: 'application\/json' \} : undefined,\s*\}\);/;
