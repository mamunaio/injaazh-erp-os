              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full bg-white/5 backdrop-blur-md border border-slate-700/50 rounded-xl pl-11 pr-12 py-3.5 text-sm text-white font-medium placeholder:text-slate-500 focus:outline-none focus:border-[#2563EB]/50 focus:ring-4 focus:ring-[#2563EB]/20 transition-all shadow-inner"
                  />
                  <button 
                    type="button"
