      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4 mb-6">
            <h3 className="font-bold text-amber-800 dark:text-amber-400 mb-2">⚠️ When to use this:</h3>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 mb-6">
            <h3 className="font-bold text-blue-800 dark:text-blue-400 mb-2">🔧 What this does:</h3>
          ...
          <div className="mt-6 p-4 bg-slate-50 dark:bg-slate-900 rounded-xl">
            <h3 className="font-bold text-sm text-slate-700 dark:text-slate-300 mb-2">📝 Example:</h3>
