...
export default function CSVImportModal({ isOpen, onClose, onSuccess }: CSVImportModalProps) {
  ...
  const handleImport = async () => {
    ...
    const mappedData = parsedData.map(row => ({
      ...
      phone: row['Corporate Phone'] || row['Phone'] || row['phone'] || '',
      linkedin_url: row['Company Linkedin Url'] || row['LinkedIn'] || row['linkedin'] || row['linkedin_url'] || '',
      person_linkedin_url: row['Person Linkedin Url'] || row['person_linkedin_url'] || '',
