...
export default function EditMarketplaceProjectModal({ 
  ...
  const handleCreateClient = async () => {
    ...
    const res = await createMarketplaceClient({ name: clientSearch, platform: project?.platform || 'Direct' });
    if (res.success) {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        >
            ...
            <div className="flex gap-5 items-center">
              ...
              <div>
                ...
                <p className="text-slate-500 dark:text-gray-400 text-sm font-medium mt-1">
                  Update the core details and parameters of this project.
                </p>
              </div>
            </div>
            <button 
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            {/* Form Area */}
            <form id="edit-project-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 md:p-10 scroll-smooth relative z-10">
