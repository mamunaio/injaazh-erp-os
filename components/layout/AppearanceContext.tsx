...
export function AppearanceProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Apply CSS variables or data attributes to document.documentElement (html tag)
    document.documentElement.setAttribute('data-accent', accentColor);
    
  }, [accentColor, sidebarLayout, mounted]);

  return (
    <AppearanceContext.Provider value={{ accentColor, setAccentColor, sidebarLayout, setSidebarLayout, mounted }}>
      {children}
